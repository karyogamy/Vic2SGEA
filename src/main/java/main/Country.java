...
public class Country implements Comparable<Country> {
    ...
    public void calcGDPPerCapita(Country totalCountry) {
        ...
        GDPPart = (float) (actualSupply / (float) totalCountry.actualSupply) * 100;
        //else
    ...
    public String getGDPPartTV() {
        return Wrapper.toPercent(GDPPart);
    }
    ...
    public String getGDPNominalPerCapita() {
        return Wrapper.toKMG(gdpNominal() / population * 100000);
    }
    ...
    public String getGDPNominal() {
        return Wrapper.toKMG(gdpNominal());
    }

    private float gdpNominal() {
        return actualSupply / (Game.goodsList.totalGoods().getInflation() / 100);
    }
    ...
    public String getUnemploymentProcentTV() {
        return Wrapper.toPercent(unemploymentProcent);
    }
    ...
    public String getUnemploymentProcentFactoryTV() {
        return Wrapper.toPercent(getUnemploymentProcentFactory());
    }
