...
public class GoodsStorage {
    public GoodsStorage(Goods igood) {
        item = igood;
    }
    ...
    public static final Comparator<GoodsStorage> actualSupplySort = new Comparator<GoodsStorage>() {
    ...
    public static final Comparator<GoodsStorage> exportSort = new Comparator<GoodsStorage>() {
    ...
    public static final Comparator<GoodsStorage> actualDemandSort = new Comparator<GoodsStorage>() {
    ...
    public static final Comparator<GoodsStorage> importedSort = new Comparator<GoodsStorage>() {
    ...
    public static final Comparator<GoodsStorage> savedCountrySupplySort = new Comparator<GoodsStorage>() {
